...
const SimplifiedArtCreator: React.FC<SimplifiedArtCreatorProps> = ({ onArtCreated }) => {
  ...
  return (
    <Card className="bg-white border border-[#e9e0ff] shadow-lg rounded-xl overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            <div className="flex justify-between items-center mb-2">
              <label className="text-gray-700 dark:text-gray-200 font-medium">Describe your vision</label>
              <div className="flex space-x-2">
                <Button 
                  variant="ghost" 
                  size="sm"
                  className="text-gray-500 hover:text-[#7c5cff] dark:text-gray-300 dark:hover:text-[#7c5cff]"
            ...
            <div className="relative">
              <Textarea
                ...
                className="resize-none border-[#e9e0ff] focus:border-[#7c5cff] p-3 bg-[#f5f0ff] dark:bg-neutral-800 dark:text-neutral-100 dark:border-neutral-700 dark:focus:border-[#7c5cff] h-24"
                value={prompt}
              ...
              <AnimatePresence>
                {prompt.length > 0 && (
                  <motion.button
                    className="absolute bottom-3 right-3 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300"
          ...
          <div className="space-y-5">
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-gray-700 dark:text-gray-200 font-medium">Style</label>
                <div className="text-sm text-gray-500 dark:text-gray-300 flex justify-between w-full max-w-[180px]">
                  <span>Abstract</span>
                  <span>Realistic</span>
                </div>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-gray-700 dark:text-gray-200 font-medium">Color Mood</label>
                <div className="text-sm text-gray-500 dark:text-gray-300 flex justify-between w-full max-w-[180px]">
                  <span>Warm</span>
                  <span>Cool</span>
                </div>
            ...
            {showAdvanced && (
              ...
              >
                <div className="space-y-5">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <label className="text-gray-700 dark:text-gray-200 font-medium">Detail Level</label>
                      <div className="text-sm text-gray-500 dark:text-gray-300 flex justify-between w-full max-w-[180px]">
                        <span>Minimal</span>
                        <span>Detailed</span>
                      </div>
                  ...
                  <div>
                    <label className="text-gray-700 dark:text-gray-200 font-medium block mb-2">Artistic Influence</label>
